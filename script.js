/** LED BOARD AUTH + ADMIN APPROVAL SYSTEM **/
...
const BASE_URL = window.location.origin; // e.g. https://ledboardoptimization.com in prod
...
const scenarioCards = [
  {
    ...
    action: 'Prioritize pedestrians. LED: "PEDESTRIAN PRIORITY"',
  ...
  },
  {
    ...
    action: 'Vehicles priority. LED: "VEHICLES PRIORITY"',
  ...
  },
  {
    ...
    action: 'Override for ambulance right-of-way. LED: "EMERGENCY STOP"',
  ...
  },
  {
    ...
    action: 'Marshal override – stop all vehicles immediately. LED: "MARSHAL OVERRIDE"',
  ...
  },
  {
    ...
    action: 'Normal operation – standard traffic light cycle. LED: "Normal Operation"',
